    ...
    return (
        <Layout allowBack={false} allowNav={true} current={'menstruation'} title={""}>
            ...
            <div className="rounded-lg border-[0.25vw] border-pink-500 bg-rose-100 my-3 grid grid-cols-4 gap-2 ">
                ...
                <h3 className='col-span-1 text-center text-sm font-sans text-red-950'> Logged Bleeding </h3>
                <h3 className='col-span-1 text-center text-sm font-sans text-red-950'> Predicted Bleeding </h3>
                <h3 className='col-span-1 text-center text-sm font-sans text-red-950'> Predicted Fertile Days </h3>
                <h3 className='col-span-1 text-center text-sm font-sans text-red-950'> Predicted Ovulation </h3>
            </div>

            <div className="grid grid-cols-2 mt-8 mb-10 gap-x-5 gap-y-5">
                <Button className="col-span-2 font-serif flex items-center justify-center text-center text-red-950 font-bold text-2xl"
                    onClick={() => navigate('/flow')}>
                    Menstrual Flow
                </Button>
                <Button
                    className="col-span-2 font-serif flex items-center justify-center text-center text-red-950 font-bold text-2xl"
                    onClick={() => navigate('/pain')}>
                    Menstrual Pain
                </Button>
                <Button
                    className="col-span-1 font-serif flex items-center justify-center text-center text-red-950 font-bold text-2xl"
