            ...
            <Layout allowBack={true} allowNav={false} title={"Today's Pain"}>
                ...
                <div className="flex-col space-y-10">
                    ...
                    <div className="flex-col mx-3 mt-5 space-y-7">
                        <Button className={twMerge("flex w-full items-center bg-cyan-100 p-2 border border-black shadow-xl", selected === "none" ? 'outline-black outline-[0.5vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-cyan-200 p-2  border border-black shadow-xl", selected === "light" ? 'outline-black outline-[0.5vw] md:outline-[0.25vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-cyan-300 p-2  border border-black shadow-xl", selected === "medium" ? ' outline-black outline-[0.5vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-cyan-400 p-2 border border-black shadow-xl", selected === "heavy" ? ' outline-black outline-[0.5vw]' : '')}
