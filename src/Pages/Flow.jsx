            ...
            <Layout allowBack={true} allowNav={false}>
                ...
                <div className="flex-col space-y-10">
                    ...
                    <div className="flex-col mx-3 mt-5 space-y-7">
                        ...
                        <Button className={twMerge("flex w-full items-center bg-rose-100 p-2 border border-zinc-700 shadow-xl", selected === "none" ? 'outline-zinc-700 outline-[0.5vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-rose-200 p-2  border border-zinc-700 shadow-xl", selected === "light" ? 'outline-zinc-700 outline-[0.5vw] md:outline-[0.25vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-rose-300 p-2  border border-zinc-700 shadow-xl", selected === "medium" ? ' outline-zinc-700 outline-[0.5vw]' : '')}
                        ...
                        <Button className={twMerge("flex w-full items-center bg-rose-400 p-2 border border-zinc-700 shadow-xl", selected === "heavy" ? ' outline-zinc-700 outline-[0.5vw]' : '')}
